package com.ciglink.common.web.entity.controller.handle;
...
public abstract class TreeHandleController<D extends TreeEntity<D>, DS extends ITreeService<D>> extends BaseController<D, DS> {
     ...
     * @see com.ciglink.common.web.entity.controller.TreeController#listExNodes(TreeEntity)
     */
     ...
     *
     * @param d 待新增数据对象
     * @see com.ciglink.common.web.entity.controller.TreeController#add(D)
     */
     ...
     *
     * @param d 待修改数据对象
     * @see com.ciglink.common.web.entity.controller.TreeController#edit(D)
     * @see com.ciglink.common.web.entity.controller.TreeController#editForce(D)
     */
     ...
     * @see com.ciglink.common.web.entity.controller.TreeController#batchRemove(List)
     */
