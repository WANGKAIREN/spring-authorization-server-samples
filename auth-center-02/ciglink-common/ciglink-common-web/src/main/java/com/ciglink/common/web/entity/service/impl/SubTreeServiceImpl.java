...
import com.ciglink.common.web.entity.service.ISubTreeService;
import com.ciglink.common.web.entity.service.impl.handle.SubTreeHandleServiceImpl;
 ...
 * @param <SM> SubMapper
 */
public abstract class SubTreeServiceImpl<D extends SubTreeEntity<D, S>, DG extends SubTreeDao<D, DM, S, SM>, DM extends SubTreeMapper<D, S>, S extends BaseEntity, SS extends IBaseService<S>, SM extends BaseMapper<S>> extends SubTreeHandleServiceImpl<D, DG, DM, S, SS, SM> implements ISubTreeService<D, S> {
