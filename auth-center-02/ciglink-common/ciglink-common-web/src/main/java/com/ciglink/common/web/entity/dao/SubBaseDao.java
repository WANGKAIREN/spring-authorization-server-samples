...
import com.ciglink.common.web.entity.dao.handle.SubBaseHandleManager;
 ...
 * 
 */
public abstract class SubBaseDao<D extends SubBaseEntity<S>, DM extends SubBaseMapper<D, S>, S extends BaseEntity, SM extends BaseMapper<S>> extends SubBaseHandleManager<D, DM, S, SM> {
