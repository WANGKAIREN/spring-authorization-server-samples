...
import com.ciglink.common.web.entity.dao.SubTreeDao;
import com.ciglink.common.web.entity.mapper.BaseMapper;
import com.ciglink.common.web.entity.mapper.SubTreeMapper;
import com.ciglink.common.web.entity.service.IBaseService;
import com.ciglink.common.web.entity.service.impl.TreeServiceImpl;
 ...
 * 
 */
public abstract class SubTreeHandleServiceImpl<D extends SubTreeEntity<D, S>, DG extends SubTreeDao<D, DM, S, SM>, DM extends SubTreeMapper<D, S>, S extends BaseEntity, SS extends IBaseService<S>, SM extends BaseMapper<S>> extends TreeServiceImpl<D, DG, DM> {
     ...
     * @param id     Id
     * @param status 状态
     * @see com.ciglink.common.web.entity.service.impl.SubTreeServiceImpl#update(SubTreeEntity)
     * @see com.ciglink.common.web.entity.service.impl.SubTreeServiceImpl#updateStatus(Serializable, String)
     */
    protected void UUSHandleSubStatusCheck(Serializable id, String status) {
        ...
        if (!ObjectUtil.equals(original.getStatus(), status)
                ...
                && ObjectUtil.isNotNull(baseDao.checkExistNormalSub(id)))
        	baseDao.updateSubStatus(id, BaseConstants.Status.DISABLE.getCode());
    }
