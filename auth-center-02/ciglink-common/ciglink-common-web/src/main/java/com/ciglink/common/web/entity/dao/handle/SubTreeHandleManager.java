 ...
 * 
 */
public abstract class SubTreeHandleManager<D extends SubTreeEntity<D, S>, DM extends SubTreeMapper<D, S>, S extends BaseEntity, SM extends BaseMapper<S>> extends TreeDao<D, DM> {
