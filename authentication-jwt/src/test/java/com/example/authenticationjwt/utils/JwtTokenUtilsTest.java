...
class JwtTokenUtilsTest {
    ...
    public void test() throws JOSEException, ParseException {
        ...
        jsonObject.put("user", "wangkairen");
        ...
        JWTClaimsSet claimsSet = new JWTClaimsSet.Builder()
                ...
                .claim("payloadText2", payloadText)
        ...
        // 验签
        assertTrue(parseJwsObject.verify(jwsVerifier));

        // 输出负载
        log.info(parseJwsObject.getPayload().toString());
    }
...
//        Payload payload = new Payload(payloadText);
        ...
        Map<String, Object> jsonObject1 = payload1.toJSONObject();
