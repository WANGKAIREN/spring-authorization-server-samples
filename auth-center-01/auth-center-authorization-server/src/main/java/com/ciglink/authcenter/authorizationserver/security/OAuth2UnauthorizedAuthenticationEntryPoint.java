...
import com.ciglink.authcenter.authorizationserver.advice.ResponseWriter;
 ...
 **/
public class OAuth2UnauthorizedAuthenticationEntryPoint extends ResponseWriter implements AuthenticationEntryPoint {
    @Override
