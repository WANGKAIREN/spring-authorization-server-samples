...
import com.example.defaultauthorizationserver.jpa.JpaOAuth2AuthorizationConsentService;
import com.example.defaultauthorizationserver.jpa.JpaOAuth2AuthorizationService;
import com.example.defaultauthorizationserver.jpa.JpaRegisteredClientRepository;
import com.example.defaultauthorizationserver.repository.AuthorizationConsentRepository;
import com.example.defaultauthorizationserver.repository.AuthorizationRepository;
...
public class AuthorizationServerConfig {
	...
	public RegisteredClientRepository registeredClientRepository(ClientRepository clientRepository) {
		RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				.redirectUri("http://127.0.0.1:8080/cc")
				.redirectUri("http://127.0.0.1:30000/login/oauth2/code/messaging-client")
				.scope(OidcScopes.OPENID)
				.scope(OidcScopes.PROFILE)
				.scope("message.read")
				.scope("message.write")
				.clientIdIssuedAt(Instant.now()) // 保存数据库必须要有的字段
	...
	@Bean
	OAuth2AuthorizationService authorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
